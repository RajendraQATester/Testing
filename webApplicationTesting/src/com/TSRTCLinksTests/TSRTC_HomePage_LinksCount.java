...
//Logic 1 (for each loop)
 
for(WebElement Raja:srini) 
{ 
	System.out.println(Raja.getText());
...
{
	WebElement Raja =srini.get(index);
	String prasad = Raja.getText();
...
/*for(int index=0;index<srini.size();index++)
{
	...
	System.out.println(srini.get(index).getText());
