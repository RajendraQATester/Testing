...
public class TSRTC_HomePage_LinksCountLogic1 {
	public static void main(String[] args) {
		...
		*/
		...
		for(int index=0;index<anchorTags.size();index++)
		{

			System.out.println(anchorTags.get(index).getText());
